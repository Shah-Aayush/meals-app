...
const DUMMY_MEALS = const [
  ...
  Meal(
    ...
    title: 'Maggi Noodles',
    imageUrl:
        'https://d1uz88p17r663j.cloudfront.net/resized/f7b71bf75bddb35c41fbf95f86cbfa7f_A42I0874_1500_700.jpg',
    ingredients: ['Maggie masala noodles packets', 'Water'],
    steps: [
  ...
  Meal(
    ...
    imageUrl:
        'https://chefjunction.in/wp-content/uploads/2020/09/Untitled-design-2020-09-26T071748.252.jpg',
    ingredients: [
      'Prepare 3/4 cup Cabbage (finely chopped)',
      'Prepare 3/4 cup Carrots (grated)',
      'Prepare 3/4 cup Capsicum (finely chopped)',
      'Take 3/4 teaspoon Ginger (Paste)',
      'Take 1 teaspoon Garlic (Paste)',
      'Get 3 tablespoons All Purpose Flour',
      'Get 1 1/2 tablespoons Cornflour',
      'Take 1 tablespoon Soy Sauce',
      'Make ready 1 tablespoon Chili Sauce',
      'Prepare to taste Salt',
      'Take 1 teaspoon Oil',
      'Prepare for the stir fry',
      'Get 1 tablespoon Oil',
      'Prepare 5 cloves Garlic (finely chopped)',
      'Get 1/2 inch Ginger piece, finely chopped',
      'Take 8 Green Onions (white part and green part chopped separately)',
      'Get 1 Green Chili 3 cups Noodles (cooked)',
      'Make ready 1/2 cup Capsicum,sliced',
      'Get 1/2 cup Cabbage (sliced)',
      'Make ready sauces',
      'Prepare 2 tablespoons Soy Sauce',
      'Make ready 1 1/2 tablespoons Vinegar',
      'Take 2 tablespoons Chili Sauce 1 tablespoon Ketchup',
      'Get 2/3 cup Water',
    ],
    steps: [
